...
module.exports = class TunnelCluster extends EventEmitter {
  constructor(opts = {}) {
    ...
    this.requestCount = 0;
    this.requestLog = [];
    this.maxRequestLogSize = opts.maxRequestLogSize || 100;
  }
  ...
  open() {
    ...
    remote.on('data', data => {
      ...
      if (match) {
        ...
        // Add to request log with size limiting
  ...
  // Get statistics about the tunnel cluster
  getStats() {
    return {
      connectionCount: this.connectionCount,
      requestCount: this.requestCount,
      recentRequests: this.requestLog.slice(0, 10)
    };
  }
